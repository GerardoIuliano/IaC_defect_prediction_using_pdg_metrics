...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/01_create_target_hosted_engine_vm.yml", "id" : "852"}</data>
...
<edge source="853" target="852" id="853-852-0">
  <data key="d9">KEYWORD</data>
  <data key="d12">"args.var"</data>
</edge>
<edge source="839" target="852" id="839-852-0">
  <data key="d9">ORDER</data>
  <data key="d10">false</data>
  <data key="d11">false</data>
</edge>
