...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "688"}</data>
...
<node id="689">
  ...
  <data key="d8">"systemctl show named | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="690">
