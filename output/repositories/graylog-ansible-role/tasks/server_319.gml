...
<graph edgedefault="directed"><data key="d0">{"path": "graylog-ansible-role/tasks/server.yml", "id" : "319"}</data>
...
<node id="320">
  ...
  <data key="d6">"graylog.server.elasticsearch.yml.j2"</data>
</node>
<node id="321">
  <data key="d2">Literal</data>
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/graylog-ansible-role/tasks/main.yml", "line": 4, "column": 3, "includer_location": null}}</data>
  <data key="d5">"str"</data>
  <data key="d6">"/etc/graylog/server/elasticsearch.yml"</data>
</node>
<node id="322">
  <data key="d2">Literal</data>
...
<node id="325">
  ...
  <data key="d8">"Configure Graylog server defaults"</data>
</node>
<node id="313">
  <data key="d2">Task</data>
  ...
  <data key="d7">"template"</data>
  <data key="d8">"Configure Graylog server"</data>
</node>
<node id="319">
  <data key="d2">Task</data>
