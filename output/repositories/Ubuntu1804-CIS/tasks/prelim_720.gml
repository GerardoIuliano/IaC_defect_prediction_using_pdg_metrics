...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "720"}</data>
...
<node id="721">
  ...
  <data key="d8">"systemctl show rsh.socket | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="722">
  <data key="d2">Variable</data>
  <data key="d3">722</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/prelim.yml", "line": 162, "column": 13, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 18, "column": 3, "includer_location": null}}</data>
...
<edge source="720" target="722">
  ...
  <data key="d15">720-722-0</data>
</edge>
<edge source="720" target="724">
  <data key="d12">ORDER</data>
  <data key="d13">false</data>
  <data key="d14">false</data>
  <data key="d15">720-724-0</data>
</edge>
<edge source="721" target="720">
  <data key="d12">KEYWORD</data>
  <data key="d16">"args._raw_params"</data>
  <data key="d15">721-720-0</data>
</edge>
<edge source="723" target="720">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">723-720-0</data>
</edge>
</graph></graphml>