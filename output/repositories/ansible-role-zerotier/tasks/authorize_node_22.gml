...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-zerotier/tasks/authorize_node.yml", "id" : "22"}</data>
...
<node id="28">
  ...
  <data key="d6">"Authorize members to network"</data>
</node>
