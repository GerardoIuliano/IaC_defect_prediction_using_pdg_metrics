...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "3488"}</data>
...
<node id="426">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/RHEL7-STIG/defaults/main.yml", "line": 285, "column": 1, "includer_location": null}</data>
  <data key="d5">"rhel_07_040400"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">1</data>
</node>
...
<edge source="426" target="3475">
  <data key="d15">USE</data>
  <data key="d16">426-3475-0</data>
</edge>
<edge source="427" target="426">
  <data key="d15">DEF</data>
  <data key="d16">427-426-0</data>
</edge>
