...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-netdata/tasks/debian.yml", "id" : "88"}</data>
<data key="d1">latest</data>
<node id="8">
  <data key="d2">Variable</data>
  <data key="d3">8</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/defaults/main.yml", "line": 26, "column": 1, "includer_location": null}</data>
  <data key="d5">"netdata_debian_pre_reqs"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">1</data>
</node>
<node id="9">
  ...
  <data key="d3">9</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/defaults/main.yml", "line": 27, "column": 3, "includer_location": null}</data>
  <data key="d9">"list"</data>
  <data key="d10">"['autoconf-archive', 'autoconf', 'autogen', 'automake', 'build-essential', 'curl', 'gcc', 'git', 'iproute', 'libmnl-dev', 'libmnl0', 'libuuid1', 'lm-sensors', 'make', 'netcat', 'pkg-config', 'python-mysqldb', 'python-psycopg2', 'python-pymongo', 'python-yaml', 'util-linux', 'uuid', 'uuid-dev', 'zlib1g-dev']"</data>
</node>
<node id="84">
  ...
  <data key="d11">"{{ netdata_debian_pre_reqs }}"</data>
  <data key="d12">[]</data>
</node>
<node id="85">
...
<node id="88">
  ...
  <data key="d5">"debian | Installing Pre-Reqs"</data>
</node>
<node id="89">
  <data key="d2">Expression</data>
  <data key="d3">89</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/tasks/debian.yml", "line": 4, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/tasks/main.yml", "line": 4, "column": 3, "includer_location": null}}</data>
...
<node id="91">
  <data key="d2">Literal</data>
  <data key="d3">91</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/tasks/debian.yml", "line": 5, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-netdata/tasks/main.yml", "line": 4, "column": 3, "includer_location": null}}</data>
