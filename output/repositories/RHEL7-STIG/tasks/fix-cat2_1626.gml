...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "1626"}</data>
...
<node id="332">
  ...
  <data key="d5">"rhel_07_030860"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">1</data>
</node>
...
<node id="1626">
  ...
  <data key="d11">"command"</data>
  <data key="d5">"MEDIUM | RHEL-07-030860 | PATCH | All uses of the modprobe command must be audited."</data>
</node>
<node id="1627">
  ...
  <data key="d12">"rhel_07_030860"</data>
  <data key="d13">[]</data>
</node>
<node id="1628">
...
<edge source="332" target="1627">
  <data key="d15">USE</data>
  <data key="d16">332-1627-0</data>
</edge>
