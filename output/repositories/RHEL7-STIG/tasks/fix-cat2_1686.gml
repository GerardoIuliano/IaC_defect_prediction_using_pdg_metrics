...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "1686"}</data>
...
<node id="1687">
  ...
  <data key="d12">"rhel_07_031010"</data>
  <data key="d13">[]</data>
</node>
<node id="1688">
...
<edge source="356" target="1687">
  <data key="d15">USE</data>
  <data key="d16">356-1687-0</data>
</edge>
