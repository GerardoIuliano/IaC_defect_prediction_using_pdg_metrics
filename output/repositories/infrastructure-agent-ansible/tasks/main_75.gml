...
<graph edgedefault="directed"><data key="d0">{"path": "infrastructure-agent-ansible/tasks/main.yml", "id" : "75"}</data>
...
<node id="75">
  ...
  <data key="d5">"setup agent service"</data>
</node>
<node id="76">
  <data key="d2">Conditional</data>
  <data key="d3">76</data>
