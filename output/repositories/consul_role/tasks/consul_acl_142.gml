...
<graph edgedefault="directed"><data key="d0">{"path": "consul_role/tasks/consul_acl.yml", "id" : "142"}</data>
...
<node id="136">
  ...
  <data key="d10">"consul_agent"</data>
  <data key="d11">[]</data>
</node>
<node id="137">
...
<edge source="142" target="144">
  ...
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">142-144-0</data>
</edge>
<edge source="143" target="142">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args._raw_params"</data>
  <data key="d18">143-142-0</data>
</edge>
</graph></graphml>