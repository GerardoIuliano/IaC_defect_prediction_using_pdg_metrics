...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "1919"}</data>
...
<node id="1920">
  ...
  <data key="d5">"rhel_07_040510"</data>
  <data key="d6">[]</data>
</node>
<node id="1921">
  <data key="d2">IntermediateValue</data>
  <data key="d3">1921</data>
  <data key="d7">248</data>
</node>
<node id="1922">
...
<node id="1912">
  ...
  <data key="d10">"blockinfile"</data>
  <data key="d11">"MEDIUM | RHEL-07-040500 | PATCH | The operating system must, for networked systems, synchronize clocks with a server that is synchronized to one of the redundant United States Naval Observatory (USNO) time servers, a time server designated for the appropriate DoD network (NIPRNet/SIPRNet), and/or the Global Positioning System (GPS)."</data>
</node>
<node id="1913">
  <data key="d2">Conditional</data>
...
<node id="410">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/RHEL7-STIG/defaults/main.yml", "line": 215, "column": 1, "includer_location": null}</data>
  <data key="d11">"rhel_07_040510"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">1</data>
</node>
...
<node id="1919">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/RHEL7-STIG/tasks/fix-cat2.yml", "line": 2133, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/RHEL7-STIG/tasks/main.yml", "line": 56, "column": 3, "includer_location": null}}</data>
  <data key="d10">"command"</data>
  <data key="d11">"MEDIUM | RHEL-07-040510 | PATCH | The operating system must protect against or limit the effects of Denial of Service (DoS) attacks by validating the operating system is implementing rate-limiting measures on impacted network interfaces."</data>
</node>
...
<edge source="410" target="1920">
  <data key="d15">USE</data>
  <data key="d16">410-1920-0</data>
</edge>
<edge source="411" target="410">
  <data key="d15">DEF</data>
  <data key="d16">411-410-0</data>
</edge>
