...
<graph edgedefault="directed"><data key="d0">{"path": "sensu-ansible/tasks/rabbit.yml", "id" : "195"}</data>
...
<node id="192">
  ...
  <data key="d6">"['{{ sensu_ssl_server_cacert }}', '{{ sensu_ssl_server_cert }}', '{{ sensu_ssl_server_key }}']"</data>
</node>
<node id="193">
...
<node id="195">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sensu-ansible/tasks/rabbit.yml", "line": 11, "column": 5, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sensu-ansible/tasks/main.yml", "line": 17, "column": 5, "includer_location": null}}</data>
  <data key="d11">"copy"</data>
  <data key="d7">"Ensure RabbitMQ SSL certs/keys are in place"</data>
</node>
<node id="196">
...
<node id="6">
  ...
  <data key="d7">"rabbitmq_config_path"</data>
  <data key="d8">0</data>
  <data key="d9">0</data>
  <data key="d10">1</data>
</node>
<node id="7">
  ...
  <data key="d6">"/etc/rabbitmq"</data>
</node>
<node id="189">
  <data key="d2">Expression</data>
  <data key="d3">189</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sensu-ansible/tasks/main.yml", "line": 17, "column": 5, "includer_location": null}}</data>
  <data key="d12">"{{ rabbitmq_config_path }}/ssl"</data>
  <data key="d13">[]</data>
</node>
<node id="190">
  <data key="d2">IntermediateValue</data>
