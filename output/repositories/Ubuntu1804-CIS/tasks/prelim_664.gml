...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "664"}</data>
...
<node id="665">
  ...
  <data key="d8">"systemctl show avahi-daemon | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="666">
  <data key="d2">Variable</data>
  <data key="d3">666</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/prelim.yml", "line": 78, "column": 13, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 18, "column": 3, "includer_location": null}}</data>
...
<edge source="659" target="664">
  ...
  <data key="d15">659-664-0</data>
</edge>
<edge source="664" target="666">
  <data key="d12">DEF</data>
  <data key="d15">664-666-0</data>
</edge>
...
<edge source="665" target="664">
  ...
  <data key="d15">665-664-0</data>
</edge>
<edge source="667" target="664">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">667-664-0</data>
</edge>
</graph></graphml>