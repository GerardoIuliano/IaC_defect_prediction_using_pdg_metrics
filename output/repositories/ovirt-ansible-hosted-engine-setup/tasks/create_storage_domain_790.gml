...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_storage_domain.yml", "id" : "790"}</data>
...
<node id="784">
  ...
  <data key="d12">"storage_domain_details.ansible_facts.ovirt_storage_domains[0].available|int &gt;= required_size|int"</data>
  <data key="d13">[]</data>
</node>
<node id="785">
...
<node id="791">
  ...
  <data key="d10">"otopi_storage_domain_details"</data>
</node>
<node id="663">
  <data key="d2">Task</data>
...
<node id="764">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/main.yml", "line": 37, "column": 5, "includer_location": null}}</data>
  <data key="d12">"{{ disk_size_xml.matches[0].Disk['{http://schemas.dmtf.org/ovf/envelope/1/}size']|int * 1024 * 1024 * 1024 + storage_domain_details.ansible_facts.ovirt_storage_domains[0].critical_space_action_blocker|int * 1024 * 1024 * 1024 + 5 * 1024 * 1024 * 1024}}"</data>
  <data key="d13">[]</data>
</node>
<node id="765">
  <data key="d2">IntermediateValue</data>
...
<edge source="791" target="790" id="791-790-0">
