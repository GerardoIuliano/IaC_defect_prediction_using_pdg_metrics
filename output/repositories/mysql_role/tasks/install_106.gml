...
<graph edgedefault="directed"><data key="d0">{"path": "mysql_role/tasks/install.yml", "id" : "106"}</data>
...
<node id="107">
  ...
  <data key="d8">"dpkg -s mysql-server | grep Status"</data>
</node>
<node id="108">
...
<edge source="104" target="106">
  ...
  <data key="d15">104-106-0</data>
</edge>
<edge source="106" target="108">
  <data key="d12">DEF</data>
  <data key="d15">106-108-0</data>
</edge>
<edge source="106" target="111">
  <data key="d12">ORDER</data>
  <data key="d13">false</data>
  <data key="d14">false</data>
  <data key="d15">106-111-0</data>
</edge>
