...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-redis/tasks/sentinel.yml", "id" : "207"}</data>
...
<node id="209">
  ...
  <data key="d7">"/etc/default/sentinel_{{ redis_sentinel_port }}"</data>
  <data key="d8">[]</data>
</node>
<node id="210">
  <data key="d2">IntermediateValue</data>
...
<node id="211">
  ...
  <data key="d14">"redis.init.conf.j2"</data>
</node>
<node id="212">
  <data key="d2">Task</data>
...
<edge source="210" target="207">
  ...
  <data key="d18">210-207-0</data>
</edge>
<edge source="211" target="207">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.src"</data>
  <data key="d18">211-207-0</data>
</edge>
<edge source="62" target="209">
  <data key="d15">USE</data>
  <data key="d18">62-209-0</data>
</edge>
