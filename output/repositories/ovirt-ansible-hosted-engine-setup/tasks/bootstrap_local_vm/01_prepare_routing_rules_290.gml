...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/01_prepare_routing_rules.yml", "id" : "290"}</data>
...
<node id="292">
  ...
  <data key="d7">"Register the engine FQDN as a host"</data>
</node>
<node id="253">
  <data key="d2">Task</data>
...
<edge source="290" target="292" id="290-292-0">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
</edge>
