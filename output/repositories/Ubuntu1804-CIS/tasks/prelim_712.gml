...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "712"}</data>
...
<node id="713">
  ...
  <data key="d8">"systemctl show snmpd | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="714">
...
<edge source="713" target="712">
  ...
  <data key="d15">713-712-0</data>
</edge>
<edge source="715" target="712">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">715-712-0</data>
</edge>
</graph></graphml>