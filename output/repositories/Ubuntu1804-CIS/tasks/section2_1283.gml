...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/section2.yml", "id" : "1283"}</data>
...
<node id="1283">
  ...
  <data key="d7">"SCORED | 2.1.2 | PATCH | Ensure daytime services are not enabled | daytime-stream"</data>
</node>
<node id="1284">
  <data key="d2">Literal</data>
  <data key="d3">1284</data>
  <data key="d5">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/section2.yml", "line": 50, "column": 19, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 29, "column": 3, "includer_location": null}}</data>
  <data key="d8">"str"</data>
  <data key="d9">"/etc/xinetd.d/daytime-stream"</data>
</node>
<node id="1285">
  ...
  <data key="d7">"daytime_stream_service"</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
...
<node id="1254">
  ...
  <data key="d7">"NOTSCORED | 1.8 | PATCH | Ensure updates, patches, and additional security software are installed"</data>
</node>
<node id="6">
  <data key="d2">Variable</data>
  <data key="d3">6</data>
...
<node id="1275">
  ...
  <data key="d6">"stat"</data>
  <data key="d7">"SCORED | 2.1.2 | PATCH | Ensure daytime services are not enabled | daytime-dgram"</data>
</node>
<node id="1277">
  <data key="d2">Variable</data>
  ...
  <data key="d7">"daytime_dgram_service"</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
  <data key="d12">18</data>
</node>
