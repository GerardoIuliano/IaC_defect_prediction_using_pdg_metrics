...
<graph edgedefault="directed"><data key="d0">{"path": "rvm1-ansible/tasks/rvm.yml", "id" : "49"}</data>
...
<node id="50">
  ...
  <data key="d12">"\"://\" in rvm1_rvm_latest_installer and not rvm_installer.stat.exists or rvm1_rvm_force_upgrade_installer"</data>
  <data key="d13">[]</data>
</node>
<node id="51">
  <data key="d2">IntermediateValue</data>
