...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_appliance.yml", "id" : "338"}</data>
...
<edge source="339" target="338" id="339-338-0">
