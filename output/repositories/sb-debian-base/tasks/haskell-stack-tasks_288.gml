...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/haskell-stack-tasks.yml", "id" : "288"}</data>
...
<node id="283">
  ...
  <data key="d12">"ansible_distribution_release == \"trusty\""</data>
  <data key="d13">[]</data>
</node>
<node id="284">
