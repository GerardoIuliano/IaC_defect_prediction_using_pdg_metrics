...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/01_create_target_hosted_engine_vm.yml", "id" : "942"}</data>
...
<node id="943">
  ...
  <data key="d7">"virsh -r domuuid {{ he_vm_name }}Local | head -1"</data>
  <data key="d8">[]</data>
</node>
<node id="944">
