...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat1.yml", "id" : "781"}</data>
...
<node id="781">
  ...
  <data key="d9">"HIGH | RHEL-07-040550 | PATCH | There must be no shosts.equiv files on the system."</data>
</node>
<node id="782">
...
<node id="784">
  ...
  <data key="d10">"str"</data>
  <data key="d11">"shosts.equiv"</data>
</node>
<node id="785">
  ...
  <data key="d9">"rhel_07_040550_audit"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
