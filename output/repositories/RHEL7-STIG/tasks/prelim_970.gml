...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/prelim.yml", "id" : "970"}</data>
...
<node id="971">
  ...
  <data key="d10">"grep -oP '^log_file\\s*=\\s*\\K.*?(?=\\s*$)' /etc/audit/auditd.conf"</data>
</node>
<node id="972">
  <data key="d2">Variable</data>
...
<edge source="971" target="970">
  ...
  <data key="d16">971-970-0</data>
</edge>
<edge source="973" target="970">
  <data key="d15">KEYWORD</data>
  <data key="d19">"check_mode"</data>
  <data key="d16">973-970-0</data>
</edge>
</graph></graphml>