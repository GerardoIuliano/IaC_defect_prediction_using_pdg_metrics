...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-gitlab-runner/tasks/install-debian.yml", "id" : "14"}</data>
...
<node id="14">
  ...
  <data key="d5">"Add GitLab apt key"</data>
</node>
<node id="15">
  ...
  <data key="d14">"https://packages.gitlab.com/gpg.key"</data>
</node>
<node id="16">
  <data key="d2">Literal</data>
  <data key="d3">16</data>
