...
<graph edgedefault="directed"><data key="d0">{"path": "rvm1-ansible/tasks/rubies.yml", "id" : "130"}</data>
...
<node id="129">
  ...
  <data key="d5">"detect_delete_ruby"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">18</data>
</node>
<node id="130">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/rvm1-ansible/tasks/rubies.yml", "line": 34, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/rvm1-ansible/tasks/main.yml", "line": 3, "column": 3, "includer_location": null}}</data>
  <data key="d9">"command"</data>
  <data key="d5">"ensure ruby version is deleted"</data>
</node>
<node id="2">
  <data key="d2">Variable</data>
  <data key="d3">2</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/rvm1-ansible/defaults/main.yml", "line": 5, "column": 1, "includer_location": null}</data>
  <data key="d5">"rvm1_delete_ruby"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">1</data>
</node>
...
<node id="134">
  ...
  <data key="d11">"{{ rvm1 }} remove {{ rvm1_delete_ruby }}"</data>
  <data key="d12">[]</data>
</node>
<node id="135">
  <data key="d2">IntermediateValue</data>
...
<node id="131">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/rvm1-ansible/tasks/rubies.yml", "line": 37, "column": 9, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/rvm1-ansible/tasks/main.yml", "line": 3, "column": 3, "includer_location": null}}</data>
  <data key="d11">"rvm1_delete_ruby and detect_delete_ruby.rc == 0"</data>
  <data key="d12">[]</data>
</node>
<node id="3">
...
<node id="123">
  ...
  <data key="d9">"command"</data>
  <data key="d5">"detect if ruby version can be deleted"</data>
</node>
<node id="126">
  <data key="d2">Conditional</data>
...
<edge source="129" target="131">
  ...
  <data key="d16">129-131-0</data>
</edge>
<edge source="2" target="131">
  <data key="d15">USE</data>
  <data key="d16">2-131-0</data>
</edge>
<edge source="2" target="134">
  <data key="d15">USE</data>
  <data key="d16">2-134-0</data>
</edge>
...
<edge source="123" target="129">
  <data key="d15">DEF</data>
  <data key="d16">123-129-0</data>
</edge>
<edge source="123" target="133">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">123-133-0</data>
</edge>
