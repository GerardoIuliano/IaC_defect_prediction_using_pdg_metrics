...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "1722"}</data>
...
<node id="553">
  ...
  <data key="d5">"rhel_07_040180"</data>
  <data key="d6">[]</data>
</node>
<node id="554">
...
<node id="368">
  ...
  <data key="d8">"rhel_07_040180"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
  <data key="d11">1</data>
</node>
...
<node id="1722">
  ...
  <data key="d8">"MEDIUM | RHEL-07-040180 | PATCH | The operating system must implement cryptography to protect the integrity of Lightweight Directory Access Protocol (LDAP) authentication communications."</data>
</node>
<node id="1725">
  <data key="d2">Conditional</data>
...
<edge source="553" target="554">
  ...
  <data key="d16">553-554-0</data>
</edge>
<edge source="554" target="1726">
  <data key="d15">USE</data>
  <data key="d16">554-1726-0</data>
</edge>
<edge source="368" target="553">
  <data key="d15">USE</data>
  <data key="d16">368-553-0</data>
</edge>
