...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-pushgateway/tasks/preflight.yml", "id" : "23"}</data>
...
<edge source="23" target="34">
  <data key="d15">DEF</data>
  <data key="d18">23-34-0</data>
</edge>
<edge source="23" target="47">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">23-47-0</data>
</edge>
