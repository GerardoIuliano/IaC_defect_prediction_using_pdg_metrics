...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_appliance.yml", "id" : "156"}</data>
...
<edge source="157" target="156" id="157-156-0">
