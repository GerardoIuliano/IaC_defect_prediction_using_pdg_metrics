...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/section4.yml", "id" : "2191"}</data>
...
<node id="2192">
  ...
  <data key="d7">"ubuntu1804cis_rule_4_2_1_4"</data>
  <data key="d8">[]</data>
</node>
<node id="2193">
  <data key="d2">IntermediateValue</data>
  <data key="d3">2193</data>
  <data key="d9">237</data>
</node>
<node id="2194">
  <data key="d2">Conditional</data>
...
<node id="304">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/defaults/main.yml", "line": 169, "column": 1, "includer_location": null}</data>
  <data key="d6">"ubuntu1804cis_rule_4_2_1_4"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">1</data>
</node>
...
<edge source="2195" target="2191">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args._raw_params"</data>
  <data key="d18">2195-2191-0</data>
</edge>
<edge source="304" target="2192">
  <data key="d15">USE</data>
  <data key="d18">304-2192-0</data>
</edge>
