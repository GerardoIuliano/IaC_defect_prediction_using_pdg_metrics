...
<graph edgedefault="directed"><data key="d0">{"path": "nexus-role/tasks/script/run_script.yml", "id" : "517"}</data>
...
<node id="515">
  ...
  <data key="d10">"docker_create_proxy_repository"</data>
</node>
<node id="516">
  <data key="d2">Variable</data>
...
<node id="525">
  ...
  <data key="d12">"{{ nexus_repositories_docker_default | combine(proxy) }}"</data>
  <data key="d13">[]</data>
</node>
<node id="526">
  <data key="d2">IntermediateValue</data>
...
<edge source="528" target="517">
  ...
  <data key="d16">528-517-0</data>
</edge>
<edge source="19" target="518">
  <data key="d15">USE</data>
  <data key="d16">19-518-0</data>
</edge>
<edge source="20" target="19">
  <data key="d15">DEF</data>
  <data key="d16">20-19-0</data>
</edge>
<edge source="21" target="518">
  <data key="d15">USE</data>
  <data key="d16">21-518-0</data>
</edge>
...
<edge source="472" target="525">
  <data key="d15">USE</data>
  <data key="d16">472-525-0</data>
</edge>
