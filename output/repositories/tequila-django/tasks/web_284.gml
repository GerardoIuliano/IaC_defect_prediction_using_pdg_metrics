...
<graph edgedefault="directed"><data key="d0">{"path": "tequila-django/tasks/web.yml", "id" : "284"}</data>
...
<node id="290">
  ...
  <data key="d6">"collectstatic"</data>
</node>
<node id="277">
  <data key="d2">Task</data>
  ...
  <data key="d6">"configure gunicorn"</data>
</node>
<node id="89">
...
<node id="284">
  ...
  <data key="d6">"ensure gunicorn is present"</data>
</node>
<node id="285">
  ...
  <data key="d10">"{{ project_name }}-server"</data>
  <data key="d11">[]</data>
</node>
<node id="286">
...
<edge source="286" target="284" id="286-284-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.name"</data>
</edge>
<edge source="287" target="284" id="287-284-0">
  <data key="d15">KEYWORD</data>
