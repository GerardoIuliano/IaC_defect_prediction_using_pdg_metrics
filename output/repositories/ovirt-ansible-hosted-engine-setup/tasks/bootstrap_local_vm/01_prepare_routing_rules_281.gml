...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/01_prepare_routing_rules.yml", "id" : "281"}</data>
...
<node id="268">
  ...
  <data key="d14">"setup"</data>
  <data key="d7">"Refresh network facts"</data>
</node>
<node id="269">
  <data key="d2">Variable</data>
...
<node id="274">
  ...
  <data key="d7">"Add outbound route rules"</data>
</node>
<node id="275">
  <data key="d2">Expression</data>
  <data key="d3">275</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/01_prepare_routing_rules.yml", "line": 49, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/main.yml", "line": 18, "column": 7, "includer_location": null}}</data>
  <data key="d11">"\"101:\tfrom \"+virbr_cidr+\" lookup main\" not in route_rules.stdout"</data>
  <data key="d12">[]</data>
</node>
<node id="276">
  <data key="d2">IntermediateValue</data>
...
<edge source="257" target="275" id="257-275-0">
...
<edge source="268" target="277" id="268-277-0">
...
<edge source="274" target="281" id="274-281-0">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
</edge>
...
<edge source="276" target="277" id="276-277-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="277" target="281" id="277-281-0">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
</edge>
...
<edge source="282" target="281" id="282-281-0">
  <data key="d15">KEYWORD</data>
