...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/main.yml", "id" : "609"}</data>
...
<node id="614">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 13, "column": 12, "includer_location": null}</data>
