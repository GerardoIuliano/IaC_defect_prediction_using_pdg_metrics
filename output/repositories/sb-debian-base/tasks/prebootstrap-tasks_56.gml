...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/prebootstrap-tasks.yml", "id" : "56"}</data>
...
<node id="61">
  ...
  <data key="d14">"deb http://ftp.debian.org/debian/ jessie main"</data>
</node>
<node id="62">
  <data key="d2">Literal</data>
  <data key="d3">62</data>
