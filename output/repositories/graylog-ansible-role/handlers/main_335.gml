...
<graph edgedefault="directed"><data key="d0">{"path": "graylog-ansible-role/handlers/main.yml", "id" : "335"}</data>
...
<node id="335">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/graylog-ansible-role/handlers/main.yml", "line": 2, "column": 3, "includer_location": null}</data>
