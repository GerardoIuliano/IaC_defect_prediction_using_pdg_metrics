...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-slurm/tasks/common.yml", "id" : "164"}</data>
...
<node id="166">
  ...
  <data key="d5">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-role-slurm/tasks/main.yml", "line": 9, "column": 3, "includer_location": null}}</data>
  <data key="d8">"str"</data>
  <data key="d9">"/etc/pam.d/slurm"</data>
</node>
<node id="167">
  <data key="d2">Literal</data>
...
<node id="158">
  ...
  <data key="d6">"yum"</data>
  <data key="d7">"install fgci Slurm addons"</data>
</node>
<node id="159">
