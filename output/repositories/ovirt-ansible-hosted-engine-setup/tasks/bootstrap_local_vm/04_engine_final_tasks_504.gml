...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/04_engine_final_tasks.yml", "id" : "504"}</data>
...
<node id="492">
  ...
  <data key="d7">"he_enable_libgfapi"</data>
  <data key="d8">[]</data>
</node>
<node id="493">
...
<node id="505">
  ...
  <data key="d14">"restart_libgfapi_support_out"</data>
</node>
<node id="507">
...
<edge source="505" target="504" id="505-504-0">
