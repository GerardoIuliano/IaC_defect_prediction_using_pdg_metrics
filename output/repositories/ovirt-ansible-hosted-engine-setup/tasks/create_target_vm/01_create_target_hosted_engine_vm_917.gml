...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/01_create_target_hosted_engine_vm.yml", "id" : "917"}</data>
...
<edge source="888" target="917" id="888-917-0">
...
<edge source="918" target="917" id="918-917-0">
