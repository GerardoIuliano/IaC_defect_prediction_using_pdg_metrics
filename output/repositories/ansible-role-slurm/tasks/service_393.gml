...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-slurm/tasks/service.yml", "id" : "393"}</data>
...
<edge source="393" target="398">
  ...
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">393-398-0</data>
</edge>
<edge source="394" target="393">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.name"</data>
  <data key="d18">394-393-0</data>
</edge>
<edge source="395" target="393">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">395-393-0</data>
</edge>
<edge source="396" target="393">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.enabled"</data>
  <data key="d18">396-393-0</data>
</edge>
