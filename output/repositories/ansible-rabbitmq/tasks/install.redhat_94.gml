...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-rabbitmq/tasks/install.redhat.yml", "id" : "94"}</data>
...
<node id="88">
  ...
  <data key="d8">"install rabbitmq-server {{ rabbitmq_version }} (RedHat)"</data>
</node>
<node id="94">
  <data key="d2">Task</data>
  <data key="d3">94</data>
...
<node id="95">
  <data key="d2">Literal</data>
  <data key="d3">95</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-rabbitmq/tasks/install.redhat.yml", "line": 33, "column": 11, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-rabbitmq/tasks/main.yml", "line": 3, "column": 5, "includer_location": null}}</data>
  <data key="d5">"str"</data>
  <data key="d6">"rabbitmq-server"</data>
</node>
...
<edge source="95" target="94" id="95-94-0">
  <data key="d9">KEYWORD</data>
