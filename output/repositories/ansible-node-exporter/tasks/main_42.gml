...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-node-exporter/tasks/main.yml", "id" : "42"}</data>
...
<node id="44">
  <data key="d2">Literal</data>
  <data key="d3">44</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-node-exporter/tasks/main.yml", "line": 57, "column": 11, "includer_location": null}</data>
  <data key="d9">"str"</data>
  <data key="d10">"/opt/node_exporter"</data>
</node>
<node id="45">
  <data key="d2">Literal</data>
  <data key="d3">45</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-node-exporter/tasks/main.yml", "line": 60, "column": 12, "includer_location": null}</data>
  <data key="d9">"str"</data>
...
<edge source="13" target="42" id="13-42-0">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.group"</data>
</edge>
...
<edge source="18" target="42" id="18-42-0">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.owner"</data>
</edge>
...
<edge source="44" target="42" id="44-42-0">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.dest"</data>
</edge>
<edge source="45" target="42" id="45-42-0">
  <data key="d15">KEYWORD</data>
