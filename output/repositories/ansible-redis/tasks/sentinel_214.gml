...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-redis/tasks/sentinel.yml", "id" : "214"}</data>
...
<node id="212">
  ...
  <data key="d9">"flush handlers to apply config changes"</data>
</node>
<node id="214">
  <data key="d2">Task</data>
  ...
  <data key="d9">"ensure sentinel is running"</data>
</node>
<node id="215">
