...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat3.yml", "id" : "4294"}</data>
...
<node id="4299">
  <data key="d2">Literal</data>
  <data key="d3">4299</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/RHEL7-STIG/tasks/fix-cat3.yml", "line": 305, "column": 18, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/project-pdg_to_file-pdg/input/repositories/RHEL7-STIG/tasks/main.yml", "line": 102, "column": 3, "includer_location": null}}</data>
  <data key="d9">"str"</data>
  <data key="d10">"The file /etc/resolv.conf is managed by network manager and shows less than two DNS servers configured. Please correct this in your DHCP configurations."</data>
</node>
<node id="1612">
  <data key="d2">Conditional</data>
...
<edge source="4286" target="4298">
  <data key="d15">USE</data>
  <data key="d16">4286-4298-0</data>
</edge>
...
<edge source="4299" target="4294">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.msg"</data>
  <data key="d16">4299-4294-0</data>
</edge>
