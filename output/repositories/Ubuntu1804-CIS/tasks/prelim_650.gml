...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "650"}</data>
...
<node id="651">
  ...
  <data key="d8">"systemctl show xinetd | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="652">
