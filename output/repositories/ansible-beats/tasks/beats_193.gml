...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-beats/tasks/beats.yml", "id" : "193"}</data>
...
<node id="193">
  ...
  <data key="d6">"Start beats service"</data>
</node>
<node id="194">
...
<node id="185">
  ...
  <data key="d6">"Copy Configuration File"</data>
</node>
...
<edge source="6" target="194">
  <data key="d15">USE</data>
  <data key="d16">6-194-0</data>
</edge>
