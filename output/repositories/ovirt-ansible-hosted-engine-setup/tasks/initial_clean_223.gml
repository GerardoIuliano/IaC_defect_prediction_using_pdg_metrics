...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/initial_clean.yml", "id" : "223"}</data>
...
<edge source="26" target="227" id="26-227-0">
  <data key="d15">USE</data>
</edge>
