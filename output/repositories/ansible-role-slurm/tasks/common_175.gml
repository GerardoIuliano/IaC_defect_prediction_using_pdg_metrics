...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-slurm/tasks/common.yml", "id" : "175"}</data>
...
<edge source="176" target="175">
  ...
  <data key="d12">176-175-0</data>
</edge>
<edge source="177" target="175">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.shell"</data>
  <data key="d12">177-175-0</data>
</edge>
<edge source="178" target="175">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.createhome"</data>
  <data key="d12">178-175-0</data>
</edge>
<edge source="179" target="175">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.home"</data>
  <data key="d12">179-175-0</data>
</edge>
<edge source="180" target="175">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.system"</data>
  <data key="d12">180-175-0</data>
</edge>
<edge source="181" target="175">
  <data key="d9">KEYWORD</data>
  <data key="d13">"args.append"</data>
  <data key="d12">181-175-0</data>
</edge>
</graph></graphml>