...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/prelim.yml", "id" : "799"}</data>
...
<node id="801">
  ...
  <data key="d6">"rpm -q python36-rpm"</data>
</node>
<node id="802">
  ...
  <data key="d7">"python36_rpm_present"</data>
  <data key="d8">0</data>
  <data key="d9">0</data>
...
<node id="799">
  ...
  <data key="d7">"Check if python36-rpm package installed"</data>
</node>
