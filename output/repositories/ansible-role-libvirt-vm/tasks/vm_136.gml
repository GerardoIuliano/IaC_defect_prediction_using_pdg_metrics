...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-libvirt-vm/tasks/vm.yml", "id" : "136"}</data>
...
<node id="138">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-role-libvirt-vm/tasks/vm.yml", "line": 24, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-role-libvirt-vm/tasks/main.yml", "line": 14, "column": 3, "includer_location": null}}</data>
  <data key="d13">"str"</data>
  <data key="d14">"running"</data>
</node>
<node id="139">
  <data key="d2">Literal</data>
...
<edge source="136" target="143">
  ...
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">136-143-0</data>
</edge>
<edge source="137" target="136">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.autostart"</data>
  <data key="d18">137-136-0</data>
</edge>
<edge source="138" target="136">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">138-136-0</data>
</edge>
