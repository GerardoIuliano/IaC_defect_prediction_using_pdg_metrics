...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "1531"}</data>
...
<node id="294">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/RHEL7-STIG/defaults/main.yml", "line": 157, "column": 1, "includer_location": null}</data>
  <data key="d5">"rhel_07_030670"</data>
  <data key="d6">0</data>
  <data key="d7">0</data>
  <data key="d8">1</data>
</node>
...
<node id="1531">
  ...
  <data key="d11">"command"</data>
  <data key="d5">"MEDIUM | RHEL-07-030670 | PATCH | All uses of the userhelper command must be audited."</data>
</node>
<node id="1532">
  ...
  <data key="d12">"rhel_07_030670"</data>
  <data key="d13">[]</data>
</node>
<node id="1533">
...
<edge source="294" target="1532">
  <data key="d15">USE</data>
  <data key="d16">294-1532-0</data>
</edge>
