...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/prebootstrap-tasks.yml", "id" : "13"}</data>
...
<node id="13">
  ...
  <data key="d6">"Set collide_user_name"</data>
</node>
<node id="14">
...
<node id="15">
  ...
  <data key="d3">15</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/main.yml", "line": 2, "column": 3, "includer_location": null}}</data>
  <data key="d10">"awk -F ':' '$3 &gt;= 1000 &amp;&amp; $3 &lt; 1020{print $1}' /etc/passwd | grep -v administrator |grep -v {{ deploy_username }}"</data>
  <data key="d11">[]</data>
</node>
<node id="16">
...
<node id="17">
  ...
  <data key="d6">"collide_user_name"</data>
  <data key="d7">0</data>
  <data key="d8">0</data>
  <data key="d9">18</data>
</node>
