...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-datadog/tasks/main.yml", "id" : "47"}</data>
...
<node id="52">
  ...
  <data key="d14">"process.yaml.j2"</data>
</node>
<node id="53">
  <data key="d2">Literal</data>
  <data key="d3">53</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": null}</data>
  <data key="d13">"str"</data>
  <data key="d14">"/etc/dd-agent/conf.d/process.yaml"</data>
</node>
<node id="55">
  <data key="d2">Conditional</data>
  <data key="d3">55</data>
...
<edge source="52" target="47">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.src"</data>
  <data key="d18">52-47-0</data>
</edge>
<edge source="53" target="47">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.dest"</data>
  <data key="d18">53-47-0</data>
</edge>
</graph></graphml>