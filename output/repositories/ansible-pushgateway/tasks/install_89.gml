...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-pushgateway/tasks/install.yml", "id" : "89"}</data>
...
<edge source="67" target="89">
  ...
  <data key="d16">67-89-0</data>
</edge>
<edge source="83" target="93">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">83-93-0</data>
</edge>
...
<edge source="95" target="89">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.mode"</data>
  <data key="d16">95-89-0</data>
</edge>
</graph></graphml>