...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-role-slurm/tasks/service.yml", "id" : "303"}</data>
...
<node id="297">
  ...
  <data key="d12">"mungekeystat is defined and mungekeystat.stat.exists == False"</data>
  <data key="d13">[]</data>
</node>
<node id="298">
