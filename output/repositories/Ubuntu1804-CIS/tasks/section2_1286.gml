...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/section2.yml", "id" : "1286"}</data>
...
<node id="1287">
  ...
  <data key="d10">"daytime_stream_service.stat.exists"</data>
  <data key="d11">[]</data>
</node>
<node id="1288">
...
<node id="1290">
  ...
  <data key="d14">"chkconfig daytime-stream off"</data>
</node>
<node id="1291">
  <data key="d2">Task</data>
