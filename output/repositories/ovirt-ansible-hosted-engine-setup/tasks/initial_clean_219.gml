...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/initial_clean.yml", "id" : "219"}</data>
...
<edge source="26" target="220" id="26-220-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="220" target="221" id="220-221-0">
  <data key="d15">DEF</data>
</edge>
<edge source="221" target="219" id="221-219-0">
