...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-rabbitmq/tasks/main.yml", "id" : "203"}</data>
...
<node id="204">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-rabbitmq/tasks/main.yml", "line": 22, "column": 11, "includer_location": null}</data>
...
<node id="205">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-rabbitmq/tasks/main.yml", "line": 23, "column": 12, "includer_location": null}</data>
  <data key="d7">"str"</data>
...
<edge source="204" target="203" id="204-203-0">
  <data key="d9">KEYWORD</data>
  <data key="d12">"args.name"</data>
</edge>
<edge source="205" target="203" id="205-203-0">
  <data key="d9">KEYWORD</data>
