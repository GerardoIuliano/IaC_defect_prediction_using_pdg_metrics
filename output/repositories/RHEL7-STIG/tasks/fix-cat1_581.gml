...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat1.yml", "id" : "581"}</data>
...
<node id="581">
  ...
  <data key="d9">"HIGH | RHEL-07-010010 | PATCH | The file permissions, ownership, and group membership of system files and commands must match the vendor values."</data>
</node>
<node id="582">
...
<node id="584">
  ...
  <data key="d9">"rhel_07_010010_audit"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
