...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_storage_domain.yml", "id" : "688"}</data>
...
<edge source="688" target="690" id="688-690-0">
