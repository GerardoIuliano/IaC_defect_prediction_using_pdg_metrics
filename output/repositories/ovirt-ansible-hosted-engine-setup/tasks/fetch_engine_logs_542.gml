...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/fetch_engine_logs.yml", "id" : "542"}</data>
...
<edge source="542" target="545" id="542-545-0">
  <data key="d9">ORDER</data>
  <data key="d10">false</data>
  <data key="d11">false</data>
</edge>
<edge source="543" target="542" id="543-542-0">
  <data key="d9">KEYWORD</data>
  <data key="d12">"args.seconds"</data>
</edge>
</graph></graphml>