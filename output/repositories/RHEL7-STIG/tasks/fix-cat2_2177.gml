...
<graph edgedefault="directed"><data key="d0">{"path": "RHEL7-STIG/tasks/fix-cat2.yml", "id" : "2177"}</data>
...
<node id="2152">
  ...
  <data key="d11">"['pam_pkcs11', 'pcsc-lite-libs']"</data>
</node>
<node id="2153">
  <data key="d2">Variable</data>
  ...
  <data key="d6">"rhel_07_010500pkcs11install"</data>
  <data key="d7">0</data>
  <data key="d8">0</data>
  <data key="d9">18</data>
</node>
