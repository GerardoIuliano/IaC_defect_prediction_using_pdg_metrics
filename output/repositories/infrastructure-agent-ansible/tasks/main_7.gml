...
<graph edgedefault="directed"><data key="d0">{"path": "infrastructure-agent-ansible/tasks/main.yml", "id" : "7"}</data>
...
<node id="14">
  ...
  <data key="d14">"redhat-lsb-core"</data>
</node>
<node id="15">
  <data key="d2">Literal</data>
  <data key="d3">15</data>
...
<edge source="14" target="7">
  ...
  <data key="d16">14-7-0</data>
</edge>
<edge source="15" target="7">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d16">15-7-0</data>
</edge>
</graph></graphml>