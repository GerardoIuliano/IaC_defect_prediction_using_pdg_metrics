...
<graph edgedefault="directed"><data key="d0">{"path": "deploy/tasks/symlink.yml", "id" : "86"}</data>
...
<node id="5">
  <data key="d2">Variable</data>
  <data key="d3">5</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/deploy/defaults/main.yml", "line": 12, "column": 1, "includer_location": null}</data>
...
<node id="6">
  <data key="d2">Literal</data>
  <data key="d3">6</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/deploy/defaults/main.yml", "line": 12, "column": 25, "includer_location": null}</data>
  <data key="d9">"str"</data>
...
<node id="87">
  <data key="d2">Literal</data>
  <data key="d3">87</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/deploy/tasks/main.yml", "line": 26, "column": 3, "includer_location": null}}</data>
  <data key="d9">"str"</data>
...
<node id="88">
  ...
  <data key="d3">88</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/deploy/tasks/main.yml", "line": 26, "column": 3, "includer_location": null}}</data>
  <data key="d12">"{{ ansistrano_deploy_to }}/{{ ansistrano_current_dir }}"</data>
  <data key="d13">[]</data>
</node>
<node id="89">
  <data key="d2">IntermediateValue</data>
...
<node id="90">
  ...
  <data key="d3">90</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/deploy/tasks/main.yml", "line": 26, "column": 3, "includer_location": null}}</data>
  <data key="d12">"{{ ansistrano_release_path.stdout }}"</data>
  <data key="d13">[]</data>
</node>
<node id="91">
  <data key="d2">IntermediateValue</data>
...
<edge source="66" target="90">
  <data key="d15">USE</data>
  <data key="d16">66-90-0</data>
</edge>
<edge source="78" target="86">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">78-86-0</data>
</edge>
