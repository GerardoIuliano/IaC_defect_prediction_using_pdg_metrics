...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-redis/tasks/install.yml", "id" : "101"}</data>
...
<node id="101">
  ...
  <data key="d5">"add redis user"</data>
</node>
<node id="102">
...
<edge source="82" target="95">
  ...
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">82-95-0</data>
</edge>
<edge source="91" target="101">
  <data key="d15">ORDER</data>
  <data key="d17">false</data>
  <data key="d18">false</data>
  <data key="d16">91-101-0</data>
</edge>
