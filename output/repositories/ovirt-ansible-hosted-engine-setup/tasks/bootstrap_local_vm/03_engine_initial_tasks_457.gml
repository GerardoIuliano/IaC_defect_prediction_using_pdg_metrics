...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/03_engine_initial_tasks.yml", "id" : "457"}</data>
...
<node id="459">
  ...
  <data key="d9">"{{ hostvars['localhost']['he_host_ip'] }} {{ hostvars['localhost']['he_host_name'] }}"</data>
  <data key="d10">[]</data>
</node>
<node id="460">
...
<edge source="458" target="457" id="458-457-0">
...
<edge source="460" target="457" id="460-457-0">
  <data key="d15">KEYWORD</data>
...
<edge source="270" target="459" id="270-459-0">
