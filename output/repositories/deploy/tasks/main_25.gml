...
<graph edgedefault="directed"><data key="d0">{"path": "deploy/tasks/main.yml", "id" : "25"}</data>
...
<node id="25">
  ...
  <data key="d6">"ANSISTRANO | Check BC for early adopters"</data>
</node>
<node id="26">
  <data key="d2">Variable</data>
  <data key="d3">26</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": null}</data>
  <data key="d6">"ansistrano_custom_tasks_path"</data>
  <data key="d7">0</data>
  <data key="d8">0</data>
  <data key="d9">0</data>
</node>
<node id="27">
  ...
  <data key="d10">"ansistrano_custom_tasks_path is defined"</data>
  <data key="d11">[]</data>
</node>
<node id="28">
...
<node id="30">
  ...
  <data key="d14">"ansistrano_custom_tasks_path is not used anymore. Please, check the documentation at https://github.com/ansistrano/deploy"</data>
</node>
<node id="31">
  <data key="d2">Task</data>
  <data key="d3">31</data>
  ...
  <data key="d6">"ANSISTRANO | Ensure deployment base path exists"</data>
</node>
<edge source="25" target="31">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">25-31-0</data>
</edge>
