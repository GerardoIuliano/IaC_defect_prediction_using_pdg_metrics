...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/02_create_local_vm.yml", "id" : "436"}</data>
...
<node id="430">
  ...
  <data key="d5">"Create an entry in /etc/hosts for the local VM"</data>
</node>
<node id="240">
...
<node id="436">
  ...
  <data key="d5">"Wait for SSH to restart on the local VM"</data>
</node>
<node id="437">
  <data key="d2">Literal</data>
...
<edge source="241" target="436" id="241-436-0">
...
<edge source="436" target="453" id="436-453-0">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
</edge>
<edge source="437" target="436" id="437-436-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.port"</data>
</edge>
<edge source="438" target="436" id="438-436-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.delay"</data>
</edge>
