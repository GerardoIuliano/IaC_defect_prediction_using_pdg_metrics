...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_appliance.yml", "id" : "326"}</data>
...
<edge source="327" target="326" id="327-326-0">
