...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "700"}</data>
...
<node id="701">
  ...
  <data key="d8">"systemctl show dovecot | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="702">
