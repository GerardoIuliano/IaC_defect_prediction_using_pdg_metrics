...
<graph edgedefault="directed"><data key="d0">{"path": "graylog-ansible-role/tasks/prepare.yml", "id" : "292"}</data>
...
<node id="293">
  ...
  <data key="d7">"{{ graylog_packages_url }}"</data>
  <data key="d8">[]</data>
</node>
<node id="294">
...
<node id="295">
  ...
  <data key="d11">"/tmp/graylog_repository.deb"</data>
</node>
<node id="296">
  <data key="d2">Task</data>
...
<node id="10">
  ...
  <data key="d3">10</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/graylog-ansible-role/defaults/main.yml", "line": 10, "column": 1, "includer_location": null}</data>
  <data key="d6">"graylog_packages_url"</data>
  <data key="d12">0</data>
  <data key="d13">0</data>
  <data key="d14">1</data>
</node>
<node id="11">
  <data key="d2">Literal</data>
  <data key="d3">11</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/graylog-ansible-role/defaults/main.yml", "line": 10, "column": 23, "includer_location": null}</data>
  <data key="d10">"str"</data>
  <data key="d11">"http://packages.graylog2.org/repo/debian/pool/stable/2.0/g/graylog-2.0-repository/graylog-2.0-repository_1-1_all.deb"</data>
</node>
