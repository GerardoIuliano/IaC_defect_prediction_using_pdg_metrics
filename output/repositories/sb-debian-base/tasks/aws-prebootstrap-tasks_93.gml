...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/aws-prebootstrap-tasks.yml", "id" : "93"}</data>
...
<node id="89">
  ...
  <data key="d6">"Enable default repos"</data>
</node>
<node id="58">
  ...
  <data key="d7">"ansible_distribution == \"Debian\""</data>
  <data key="d8">[]</data>
</node>
<node id="59">
