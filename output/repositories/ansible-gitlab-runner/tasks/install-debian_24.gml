...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-gitlab-runner/tasks/install-debian.yml", "id" : "24"}</data>
...
<node id="24">
  ...
  <data key="d6">"Add GitLab Runner apt repo"</data>
</node>
<node id="25">
...
<node id="27">
  ...
  <data key="d10">"deb https://packages.gitlab.com/runner/gitlab-ci-multi-runner/{{ ansible_distribution | lower }}/ {{ ansible_distribution_major_version }} main"</data>
  <data key="d11">[]</data>
</node>
<node id="28">
...
<edge source="18" target="24">
  ...
  <data key="d18">18-24-0</data>
</edge>
<edge source="24" target="30">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">24-30-0</data>
</edge>
...
<edge source="28" target="24">
  ...
  <data key="d18">28-24-0</data>
</edge>
<edge source="29" target="24">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">29-24-0</data>
</edge>
</graph></graphml>