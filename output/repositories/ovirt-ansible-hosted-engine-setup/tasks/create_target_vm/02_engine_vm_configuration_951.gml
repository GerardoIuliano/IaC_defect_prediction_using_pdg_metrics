...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/02_engine_vm_configuration.yml", "id" : "951"}</data>
...
<node id="948">
  ...
  <data key="d10">"he_engine_vm_configuration"</data>
  <data key="d11">[]</data>
</node>
<node id="949">
...
<node id="952">
  ...
  <data key="d14">"ls -vr1 /etc/ovirt-engine/engine.conf.d/*-scl-postgres-*.conf"</data>
</node>
<node id="953">
  <data key="d2">Variable</data>
