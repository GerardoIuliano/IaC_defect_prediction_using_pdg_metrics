...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-beats/tasks/beats-debian.yml", "id" : "50"}</data>
...
<node id="52">
  ...
  <data key="d10">"http://packages.elasticsearch.org/GPG-KEY-elasticsearch"</data>
</node>
<node id="53">
  <data key="d2">Literal</data>
  <data key="d3">53</data>
