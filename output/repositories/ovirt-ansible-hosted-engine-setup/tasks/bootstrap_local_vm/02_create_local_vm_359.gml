...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/02_create_local_vm.yml", "id" : "359"}</data>
...
<edge source="360" target="359" id="360-359-0">
  <data key="d15">KEYWORD</data>
