...
<graph edgedefault="directed"><data key="d0">{"path": "sensu-ansible/tasks/SmartOS/client.yml", "id" : "304"}</data>
...
<node id="298">
  ...
  <data key="d6">"Deploy Sensu client service manifest"</data>
</node>
<node id="306">
  <data key="d2">Task</data>
