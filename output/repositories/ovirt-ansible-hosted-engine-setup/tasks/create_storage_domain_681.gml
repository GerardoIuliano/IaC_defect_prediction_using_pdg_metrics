...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_storage_domain.yml", "id" : "681"}</data>
...
<edge source="682" target="681" id="682-681-0">
