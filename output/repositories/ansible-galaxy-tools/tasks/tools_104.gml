...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-galaxy-tools/tasks/tools.yml", "id" : "104"}</data>
...
<node id="105">
  ...
  <data key="d7">"{{ galaxy_tools_tool_list_file }}"</data>
  <data key="d8">[]</data>
</node>
<node id="106">
...
<node id="107">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 6, "column": 3, "includer_location": null}}</data>
  <data key="d7">"{{ galaxy_tools_base_dir }}/tool_list.yaml"</data>
  <data key="d8">[]</data>
</node>
<node id="108">
  <data key="d2">IntermediateValue</data>
...
<node id="109">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/tools.yml", "line": 15, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 6, "column": 3, "includer_location": null}}</data>
  <data key="d5">"command"</data>
  <data key="d6">"Install Tool Shed tools"</data>
</node>
<node id="8">
  <data key="d2">Variable</data>
  <data key="d3">8</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/defaults/main.yml", "line": 13, "column": 1, "includer_location": null}</data>
  <data key="d6">"galaxy_tools_tool_list_file"</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
  <data key="d12">1</data>
</node>
<node id="9">
  ...
  <data key="d3">9</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/defaults/main.yml", "line": 13, "column": 30, "includer_location": null}</data>
  <data key="d13">"str"</data>
  <data key="d14">"tool_list.yaml"</data>
</node>
<node id="10">
  <data key="d2">Variable</data>
  <data key="d3">10</data>
