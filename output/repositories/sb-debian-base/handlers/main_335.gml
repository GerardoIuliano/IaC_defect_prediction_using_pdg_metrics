...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/handlers/main.yml", "id" : "335"}</data>
...
<node id="339">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/handlers/main.yml", "line": 4, "column": 18, "includer_location": null}</data>
  <data key="d7">"str"</data>
