...
from rq1_base import rfecv, pdg_metrics_only, iac_metrics_only, delta_metrics_only, process_metrics_only

def rq1_analyze_pdg(repository : str):
    ...
    dest = 'rq1/result/pdg/'+repository.replace("/","_")+'.json'
    with open(dest, 'w') as outfile:
        json.dump(result, outfile)

def rq1_analyze_iac(repository : str):
    data = pd.read_csv('kaggle/input/iac-defect-prediction-using-pdg-metrics/ansible.csv')
    data = data[data.repository == repository].fillna(0)
    ...
    dest = 'rq1/result/iac/'+repository.replace("/","_")+'.json'
    with open(dest, 'w') as outfile:
        json.dump(result, outfile)

def rq1_analyze_process(repository : str):
    data = pd.read_csv('kaggle/input/iac-defect-prediction-using-pdg-metrics/ansible.csv')
    data = data[data.repository == repository].fillna(0)
    ...
    dest = 'rq1/result/process/'+repository.replace("/","_")+'.json'
    with open(dest, 'w') as outfile:
        json.dump(result, outfile)

def rq1_analyze_delta(repository : str):
    data = pd.read_csv('kaggle/input/iac-defect-prediction-using-pdg-metrics/ansible.csv')
    data = data[data.repository == repository].fillna(0)
    ...
    dest = 'rq1/result/delta/'+repository.replace("/","_")+'.json'
    with open(dest, 'w') as outfile:
        json.dump(result, outfile)