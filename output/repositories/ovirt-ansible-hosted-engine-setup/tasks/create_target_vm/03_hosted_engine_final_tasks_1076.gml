...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/03_hosted_engine_final_tasks.yml", "id" : "1076"}</data>
...
<node id="1077">
  ...
  <data key="d8">"get_spm_id_out"</data>
</node>
...
<edge source="1077" target="1076" id="1077-1076-0">
