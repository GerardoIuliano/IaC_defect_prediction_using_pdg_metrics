...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/aws-prebootstrap-tasks.yml", "id" : "89"}</data>
...
<node id="91">
  ...
  <data key="d6">"deb http://ftp.debian.org/debian/ jessie main"</data>
</node>
<node id="84">
  ...
  <data key="d8">"Add OS user"</data>
</node>
<node id="89">
  <data key="d2">Task</data>
  <data key="d3">89</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/aws-prebootstrap-tasks.yml", "line": 7, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/main.yml", "line": 7, "column": 3, "includer_location": null}}</data>
  <data key="d7">"apt_repository"</data>
  <data key="d8">"Enable default repos"</data>
</node>
<node id="58">
...
<node id="93">
  <data key="d2">Task</data>
  <data key="d3">93</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/aws-prebootstrap-tasks.yml", "line": 11, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/main.yml", "line": 7, "column": 3, "includer_location": null}}</data>
  <data key="d7">"apt"</data>
  <data key="d8">"Update packges"</data>
</node>
<node id="57">
...
<edge source="59" target="90">
  ...
  <data key="d18">59-90-0</data>
</edge>
<edge source="92" target="89">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.state"</data>
  <data key="d18">92-89-0</data>
</edge>
