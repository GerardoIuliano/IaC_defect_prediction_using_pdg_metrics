...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-galaxy-tools/tasks/restart_galaxy.yml", "id" : "76"}</data>
...
<node id="76">
  ...
  <data key="d6">"Start Galaxy"</data>
</node>
<node id="77">
  <data key="d2">Expression</data>
  <data key="d3">77</data>
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/bootstrap_user.yml", "line": 22, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 3, "column": 3, "includer_location": null}}}</data>
  <data key="d7">"{{ galaxy_server_dir }}/run.sh --pid-file={{ galaxy_tools_pid_file_name }} --log-file={{ galaxy_tools_log_file_name }} --daemon"</data>
  <data key="d8">[]</data>
</node>
<node id="78">
...
<node id="79">
  ...
  <data key="d5">"wait_for"</data>
  <data key="d6">"Wait for Galaxy to start"</data>
</node>
<node id="16">
...
<edge source="78" target="76">
  ...
  <data key="d18">78-76-0</data>
</edge>
<edge source="16" target="77">
  <data key="d15">USE</data>
  <data key="d18">16-77-0</data>
</edge>
