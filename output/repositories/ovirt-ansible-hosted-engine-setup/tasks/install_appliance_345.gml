...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_appliance.yml", "id" : "345"}</data>
...
<edge source="346" target="345" id="346-345-0">
