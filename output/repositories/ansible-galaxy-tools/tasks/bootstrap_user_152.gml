...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-galaxy-tools/tasks/bootstrap_user.yml", "id" : "152"}</data>
...
<node id="23">
  ...
  <data key="d12">"/mnt/galaxy/galaxy-app"</data>
</node>
<node id="152">
  <data key="d2">Task</data>
...
<node id="153">
  ...
  <data key="d5">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy-tools/tasks/main.yml", "line": 9, "column": 3, "includer_location": null}}</data>
  <data key="d11">"str"</data>
  <data key="d12">"absent"</data>
</node>
<node id="31">
...
<edge source="32" target="152">
  <data key="d15">KEYWORD</data>
  <data key="d16">"args.dest"</data>
  <data key="d17">32-152-0</data>
</edge>
<edge source="147" target="152">
  <data key="d15">ORDER</data>
  <data key="d18">false</data>
  <data key="d19">false</data>
  <data key="d17">147-152-0</data>
</edge>
