...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-pushgateway/tasks/install.yml", "id" : "60"}</data>
...
<node id="65">
  ...
  <data key="d8">"Create the pushgateway user"</data>
</node>
<node id="12">
...
<node id="60">
  ...
  <data key="d8">"Create the pushgateway group"</data>
</node>
<node id="61">
...
<edge source="54" target="60">
  ...
  <data key="d17">54-60-0</data>
</edge>
<edge source="60" target="65">
  <data key="d15">ORDER</data>
  <data key="d18">false</data>
  <data key="d19">false</data>
  <data key="d17">60-65-0</data>
</edge>
