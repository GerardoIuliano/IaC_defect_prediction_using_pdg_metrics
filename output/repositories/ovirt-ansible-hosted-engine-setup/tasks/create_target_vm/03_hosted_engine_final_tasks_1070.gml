...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/03_hosted_engine_final_tasks.yml", "id" : "1070"}</data>
...
<node id="1059">
  ...
  <data key="d5">"{{ he_vm_name }}Local"</data>
  <data key="d6">[]</data>
</node>
<node id="1060">
...
<node id="1062">
  ...
  <data key="d5">"qemu+tls://{{ he_host_name }}/system"</data>
  <data key="d6">[]</data>
</node>
<node id="1063">
  <data key="d2">IntermediateValue</data>
...
<edge source="1060" target="1070" id="1060-1070-0">
...
<edge source="1063" target="1070" id="1063-1070-0">
  <data key="d15">KEYWORD</data>
...
<edge source="1071" target="1070" id="1071-1070-0">
  <data key="d15">KEYWORD</data>
