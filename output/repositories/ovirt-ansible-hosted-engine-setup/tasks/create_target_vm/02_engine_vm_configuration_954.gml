...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/02_engine_vm_configuration.yml", "id" : "954"}</data>
...
<node id="955">
  ...
  <data key="d8">"scl_conf_flist"</data>
</node>
<node id="956">
  <data key="d2">Task</data>
