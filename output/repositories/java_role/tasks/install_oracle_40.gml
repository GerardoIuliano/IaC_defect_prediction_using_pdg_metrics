...
<graph edgedefault="directed"><data key="d0">{"path": "java_role/tasks/install_oracle.yml", "id" : "40"}</data>
...
<node id="40">
  ...
  <data key="d14">"debconf"</data>
  <data key="d5">"Autoaccept license for Java"</data>
</node>
<node id="41">
  <data key="d2">Expression</data>
  <data key="d3">41</data>
...
<node id="43">
  ...
  <data key="d10">"shared/accepted-oracle-license-v1-1"</data>
</node>
<node id="44">
  <data key="d2">Literal</data>
  <data key="d3">44</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/java_role/tasks/install_oracle.yml", "line": 22, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/java_role/tasks/main.yml", "line": 3, "column": 3, "includer_location": null}}</data>
  <data key="d9">"str"</data>
...
<edge source="43" target="40">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.question"</data>
