...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "748"}</data>
...
<node id="749">
  ...
  <data key="d8">"systemctl show autofs | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="750">
...
<edge source="744" target="748">
  ...
  <data key="d15">744-748-0</data>
</edge>
<edge source="748" target="750">
  <data key="d12">DEF</data>
  <data key="d15">748-750-0</data>
</edge>
...
<edge source="749" target="748">
  ...
  <data key="d15">749-748-0</data>
</edge>
<edge source="751" target="748">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">751-748-0</data>
</edge>
</graph></graphml>