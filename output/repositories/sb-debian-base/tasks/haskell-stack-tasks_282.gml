...
<graph edgedefault="directed"><data key="d0">{"path": "sb-debian-base/tasks/haskell-stack-tasks.yml", "id" : "282"}</data>
...
<node id="282">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/haskell-stack-tasks.yml", "line": 13, "column": 3, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/sb-debian-base/tasks/main.yml", "line": 46, "column": 3, "includer_location": null}}</data>
  <data key="d5">"apt_repository"</data>
  <data key="d6">"Add FPCO Deb repository"</data>
</node>
<node id="283">
...
<node id="286">
  ...
  <data key="d14">"deb http://download.fpcomplete.com/ubuntu trusty main"</data>
</node>
<node id="287">
  <data key="d2">Literal</data>
