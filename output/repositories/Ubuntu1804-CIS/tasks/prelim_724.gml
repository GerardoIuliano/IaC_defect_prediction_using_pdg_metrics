...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "724"}</data>
...
<node id="725">
  ...
  <data key="d8">"systemctl show rlogin.socket | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="726">
...
<edge source="725" target="724">
  ...
  <data key="d15">725-724-0</data>
</edge>
<edge source="727" target="724">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">727-724-0</data>
</edge>
</graph></graphml>