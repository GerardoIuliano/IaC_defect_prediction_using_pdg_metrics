...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-redis/tasks/install.yml", "id" : "105"}</data>
...
<node id="106">
  ...
  <data key="d12">"http://download.redis.io/releases/redis-{{ redis_version }}.tar.gz"</data>
  <data key="d13">[]</data>
</node>
<node id="107">
...
<edge source="0" target="106">
  ...
  <data key="d16">0-106-0</data>
</edge>
<edge source="0" target="108">
  <data key="d15">USE</data>
  <data key="d16">0-108-0</data>
</edge>
