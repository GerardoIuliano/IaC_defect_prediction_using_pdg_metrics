...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/section5.yml", "id" : "2328"}</data>
...
<node id="12">
  ...
  <data key="d8">"ubuntu1804cis_section5"</data>
  <data key="d9">0</data>
  <data key="d10">0</data>
  <data key="d11">1</data>
</node>
...
<node id="2325">
  ...
  <data key="d8">"SCORED | 5.1.8 | PATCH | Ensure at/cron is restricted to authorized users"</data>
</node>
<node id="2328">
  <data key="d2">Task</data>
  ...
  <data key="d8">"SCORED | 5.1.8 | PATCH | Check if cron.allow exists"</data>
</node>
<node id="2329">
  <data key="d2">Literal</data>
  <data key="d3">2329</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/section5.yml", "line": 137, "column": 19, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 44, "column": 3, "includer_location": null}}</data>
  <data key="d12">"str"</data>
  <data key="d13">"/etc/cron.allow"</data>
</node>
<node id="2330">
  <data key="d2">Variable</data>
...
<edge source="2325" target="2328">
  ...
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">2325-2328-0</data>
</edge>
<edge source="2328" target="2330">
  <data key="d15">DEF</data>
  <data key="d18">2328-2330-0</data>
</edge>
<edge source="2328" target="2331">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
  <data key="d18">2328-2331-0</data>
</edge>
<edge source="2329" target="2328">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args.path"</data>
  <data key="d18">2329-2328-0</data>
</edge>
