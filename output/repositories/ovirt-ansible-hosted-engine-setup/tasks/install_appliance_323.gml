...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_appliance.yml", "id" : "323"}</data>
...
<node id="324">
  ...
  <data key="d8">"grep path /etc/ovirt-hosted-engine/10-appliance.conf | cut -f2 -d'='"</data>
</node>
<node id="325">
