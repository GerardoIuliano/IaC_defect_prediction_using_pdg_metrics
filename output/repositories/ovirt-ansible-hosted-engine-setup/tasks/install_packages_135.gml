...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/install_packages.yml", "id" : "135"}</data>
...
<node id="135">
  ...
  <data key="d5">"Install oVirt Hosted Engine packages"</data>
</node>
<node id="136">
  <data key="d2">Literal</data>
  ...
  <data key="d10">"ovirt-hosted-engine-setup"</data>
</node>
<node id="137">
  <data key="d2">Literal</data>
...
<edge source="135" target="138" id="135-138-0">
  <data key="d15">ORDER</data>
  <data key="d16">false</data>
  <data key="d17">false</data>
</edge>
...
<edge source="137" target="135" id="137-135-0">
  <data key="d15">KEYWORD</data>
