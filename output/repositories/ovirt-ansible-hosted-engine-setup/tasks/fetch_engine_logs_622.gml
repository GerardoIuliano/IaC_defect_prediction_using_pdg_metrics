...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/fetch_engine_logs.yml", "id" : "622"}</data>
...
<node id="553">
  ...
  <data key="d10">"he_bootstrap_local_vm_add_host"</data>
  <data key="d11">[]</data>
</node>
<node id="554">
  <data key="d2">IntermediateValue</data>
...
<node id="88">
  ...
  <data key="d6">"he_enable_hc_gluster_service"</data>
  <data key="d7">0</data>
  <data key="d8">0</data>
  <data key="d9">1</data>
</node>
...
<node id="614">
  ...
  <data key="d10">"host_result_up_check is succeeded and host_result_up_check.ansible_facts.ovirt_hosts|length &gt;= 1 and host_result_up_check.ansible_facts.ovirt_hosts[0].status == 'non_operational'"</data>
...
<edge source="621" target="624" id="621-624-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="623" target="622" id="623-622-0">
...
<edge source="627" target="622" id="627-622-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.group"</data>
</edge>
<edge source="628" target="622" id="628-622-0">
  <data key="d15">KEYWORD</data>
