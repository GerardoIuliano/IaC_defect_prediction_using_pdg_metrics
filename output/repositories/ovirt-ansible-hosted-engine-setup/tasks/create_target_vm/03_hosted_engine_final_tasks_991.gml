...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_target_vm/03_hosted_engine_final_tasks.yml", "id" : "991"}</data>
...
<edge source="994" target="991" id="994-991-0">
  <data key="d15">KEYWORD</data>
  <data key="d18">"args.serial_console"</data>
</edge>
