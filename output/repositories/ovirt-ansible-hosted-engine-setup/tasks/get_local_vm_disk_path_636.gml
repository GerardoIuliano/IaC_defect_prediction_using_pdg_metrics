...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/get_local_vm_disk_path.yml", "id" : "636"}</data>
...
<edge source="636" target="644" id="636-644-0">
...
<edge source="637" target="636" id="637-636-0">
