...
<graph edgedefault="directed"><data key="d0">{"path": "ansible-galaxy/tasks/database.yml", "id" : "136"}</data>
...
<node id="137">
  ...
  <data key="d7">"'migrate.exceptions.DatabaseNotControlledError' in current_db_version.stderr"</data>
  <data key="d8">[]</data>
</node>
<node id="138">
  <data key="d2">IntermediateValue</data>
...
<node id="140">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ansible-galaxy/tasks/main.yml", "line": 21, "column": 3, "includer_location": null}}</data>
  <data key="d7">"{{ galaxy_venv_dir }}/bin/python {{ galaxy_server_dir }}/scripts/create_db.py -c {{ galaxy_config_file }}"</data>
  <data key="d8">[]</data>
</node>
<node id="141">
  <data key="d2">IntermediateValue</data>
...
<edge source="141" target="136">
  <data key="d15">KEYWORD</data>
  <data key="d19">"args._raw_params"</data>
  <data key="d16">141-136-0</data>
</edge>
<edge source="14" target="129">
  <data key="d15">USE</data>
  <data key="d16">14-129-0</data>
</edge>
<edge source="14" target="140">
  <data key="d15">USE</data>
  <data key="d16">14-140-0</data>
</edge>
