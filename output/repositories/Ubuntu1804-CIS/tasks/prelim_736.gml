...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "736"}</data>
...
<node id="737">
  ...
  <data key="d8">"systemctl show tftp | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="738">
