...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/get_local_vm_disk_path.yml", "id" : "384"}</data>
...
<edge source="384" target="392" id="384-392-0">
...
<edge source="385" target="384" id="385-384-0">
