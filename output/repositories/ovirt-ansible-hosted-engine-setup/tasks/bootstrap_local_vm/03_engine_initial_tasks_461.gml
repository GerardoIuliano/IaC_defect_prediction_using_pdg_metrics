...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/bootstrap_local_vm/03_engine_initial_tasks.yml", "id" : "461"}</data>
...
<node id="79">
  ...
  <data key="d14">"engine.example.com"</data>
</node>
...
<edge source="463" target="461" id="463-461-0">
...
<edge source="78" target="462" id="78-462-0">
