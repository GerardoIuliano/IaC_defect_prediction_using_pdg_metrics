...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/clean_localvm_dir.yml", "id" : "443"}</data>
...
<edge source="443" target="445" id="443-445-0">
  <data key="d9">ORDER</data>
  <data key="d10">false</data>
  <data key="d11">false</data>
</edge>
<edge source="444" target="443" id="444-443-0">
