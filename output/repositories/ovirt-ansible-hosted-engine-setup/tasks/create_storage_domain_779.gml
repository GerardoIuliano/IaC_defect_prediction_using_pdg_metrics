...
<graph edgedefault="directed"><data key="d0">{"path": "ovirt-ansible-hosted-engine-setup/tasks/create_storage_domain.yml", "id" : "779"}</data>
...
<node id="770">
  ...
  <data key="d5">"storage_domain_details.ansible_facts.ovirt_storage_domains[0].available|int &lt; required_size|int"</data>
  <data key="d6">[]</data>
</node>
<node id="771">
...
<node id="781">
  ...
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/create_storage_domain.yml", "line": 150, "column": 12, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/main.yml", "line": 37, "column": 5, "includer_location": null}}</data>
  <data key="d5">"Error: the target storage domain contains only {{ storage_domain_details.ansible_facts.ovirt_storage_domains[0].available|int / 1024 / 1024 / 1024 }}GiB of available space while a minimum of {{ required_size|int / 1024 / 1024 / 1024 }}GiB is required If you wish to use the current target storage domain by extending it, make sure it contains nothing before adding it."</data>
  <data key="d6">[]</data>
</node>
<node id="782">
  <data key="d2">IntermediateValue</data>
...
<node id="14">
  ...
  <data key="d9">"he_create_storage_domain"</data>
  <data key="d10">0</data>
  <data key="d11">0</data>
  <data key="d12">1</data>
</node>
...
<node id="733">
  ...
  <data key="d8">"ovirt_storage_domains"</data>
...
<node id="481">
  ...
  <data key="d5">"{{ hostvars['localhost']['he_local_vm_dir'] }}"</data>
  <data key="d6">[]</data>
</node>
<node id="482">
  <data key="d2">IntermediateValue</data>
...
<node id="741">
  ...
  <data key="d8">"ovirt_storage_domains_facts"</data>
...
<node id="618">
  ...
  <data key="d9">"Remove host-deploy configuration file"</data>
</node>
<node id="747">
  <data key="d2">Task</data>
...
<node id="764">
  ...
  <data key="d4">{"file": "unknown file", "line": -1, "column": -1, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/ovirt-ansible-hosted-engine-setup/tasks/main.yml", "line": 37, "column": 5, "includer_location": null}}</data>
  <data key="d5">"{{ disk_size_xml.matches[0].Disk['{http://schemas.dmtf.org/ovf/envelope/1/}size']|int * 1024 * 1024 * 1024 + storage_domain_details.ansible_facts.ovirt_storage_domains[0].critical_space_action_blocker|int * 1024 * 1024 * 1024 + 5 * 1024 * 1024 * 1024}}"</data>
  <data key="d6">[]</data>
</node>
<node id="765">
  <data key="d2">IntermediateValue</data>
...
<edge source="782" target="779" id="782-779-0">
...
<edge source="744" target="781" id="744-781-0">
  <data key="d15">USE</data>
</edge>
...
<edge source="766" target="781" id="766-781-0">
  <data key="d15">USE</data>
</edge>
</graph></graphml>