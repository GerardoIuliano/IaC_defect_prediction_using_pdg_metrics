...
<graph edgedefault="directed"><data key="d0">{"path": "Ubuntu1804-CIS/tasks/prelim.yml", "id" : "744"}</data>
...
<node id="745">
  ...
  <data key="d8">"systemctl show ntalk | grep LoadState | cut -d = -f 2"</data>
</node>
<node id="746">
  <data key="d2">Variable</data>
  <data key="d3">746</data>
  <data key="d4">{"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/prelim.yml", "line": 198, "column": 13, "includer_location": {"file": "/mnt/c/Users/gerar/Desktop/IaC_defect_prediction_using_pdg_metrics/input/repositories/Ubuntu1804-CIS/tasks/main.yml", "line": 18, "column": 3, "includer_location": null}}</data>
...
<edge source="745" target="744">
  ...
  <data key="d15">745-744-0</data>
</edge>
<edge source="747" target="744">
  <data key="d12">KEYWORD</data>
  <data key="d16">"check_mode"</data>
  <data key="d15">747-744-0</data>
</edge>
</graph></graphml>