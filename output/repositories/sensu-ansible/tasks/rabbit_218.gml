...
<graph edgedefault="directed"><data key="d0">{"path": "sensu-ansible/tasks/rabbit.yml", "id" : "218"}</data>
...
<node id="214">
  ...
  <data key="d11">"rabbitmq_state|changed"</data>
...
<node id="218">
  ...
  <data key="d14">"rabbitmq_vhost"</data>
...
<node id="219">
  ...
  <data key="d11">"{{ rabbitmq_sensu_vhost }}"</data>
  <data key="d12">[]</data>
</node>
<node id="220">
  <data key="d2">IntermediateValue</data>
